        ...
        <div className="min-h-screen bg-gray-100 flex flex-col items-center py-10">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-2xl flex flex-col items-center">
                ...
                <div className="flex gap-4">
                    <button
                        onClick={capture}
                        disabled={loading}
                        className={`px-8 py-3 rounded-full font-bold text-white text-lg ${loading ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'
                            }`}
                    >
            ...
            {result && (
                <div className="fixed inset-0 flex items-center justify-center z-50 p-4 pointer-events-none">
                    <div className={`bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 transform transition-all pointer-events-auto ${result.success ? 'border-4 border-green-500' : 'border-4 border-red-500'
                        }`}>
                        {result.success ? (
                            <div className="text-center space-y-4">
                                ...
                                <button
                                    ...
                                    className="mt-4 bg-green-500 text-white px-6 py-2 rounded-full hover:bg-green-600 font-bold"
                                >
                                    Đóng
                                </button>
                            </div>
                            ...
                            <div className="text-center space-y-4">
                                ...
                                <button
                                    onClick={() => setResult(null)}
                                    className="mt-4 bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-600 font-bold"
                                >
                                    Thử lại
                                </button>
                            </div>
